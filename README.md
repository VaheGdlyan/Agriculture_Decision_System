...
| **Research Foundations** | Full mathematical breakdown and ablation study (CVPR). | [**Read Research Paper**](https://github.com/VaheGdlyan/Agriculture_Decision_System/blob/main/AgriVision_Paper/AgriVision_CVPR_Draft.pdf) |
